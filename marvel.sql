...
-- UPDATE people SET name ='Jean BaMaung' WHERE name = 'Gean BaMaung';

-- 4. Return ONLY your name from the 'people' table.

-- SELECT name FROM people WHERE NAME = 'Deborah Gemmell';

--5. The cinema is showing 'Batman Begins', but Batman is DC, not Marvel! Delete the entry from the 'movies' table.
-- DELETE FROM movies WHERE title = 'Batman Begins';

-- 6. Create a new entry in the 'people' table with the name of one of the instructors.
-- INSERT INTO people (name) VALUES ('allanrussell');
...
-- 7. Jeff Bridges has decided to hijack our movie evening, Remove him from the table of people.
 ...
 -- exclusive midnight showing of 'Avengers: Infinity War'!! Create a new entry in the 'movies' table to reflect this. (The year should be 2018)
 --  INSERT INTO movies (title, year, show_time) VALUES ('Avengers: Infinity War', 2018, '14:30');

-- 9. The cinema would also like to make the Guardian movies a back to back feature. Update the 'Guardians of the Galaxy' show time from 21:40 to 23:00
     -- UPDATE movies SET show_time = '23:00' WHERE title = 'Guardians of the Galaxy 2' AND show_time = '21:40';
